...
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN P5} [get_ports {button[4]}]
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN P4} [get_ports {button[3]}]
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN P2} [get_ports {button[2]}]
...
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN F15} [get_ports {seg_out[7]}]
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN F13} [get_ports {seg_out[6]}]
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN F14} [get_ports {seg_out[5]}]
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN F16} [get_ports {seg_out[4]}]
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN E17} [get_ports {seg_out[3]}]
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN C14} [get_ports {seg_out[2]}]
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN C15} [get_ports {seg_out[1]}]
set_property -dict {IOSTANDARD LVCMOS33 PACKAGE_PIN E13} [get_ports {seg_out[0]}]